// Dagger CI module for homerun2-demo-pitcher
//
...
func (m *Dagger) BuildImage(
	...
	src *dagger.Directory,
	// +optional
	// +default="ko.local/homerun2-demo-pitcher"
	repo string,
	// +optional
	// +default="false"
	push string,
...
func (m *Dagger) SmokeTest(
	ctx context.Context,
	// The base URL of the deployed pitcher (e.g., https://homerun2-demo-pitcher.example.com)
	endpoint string,
